    ...
    grunt.initConfig({
      ...
      watch: {
        files: [
          ...
          '<%= basePath %>/test/mock/**/*.js',
          '<%= basePath %>/app/**/*',
          '!<%= basePath %>/app/.meteor/local/**/*',
          '!<%= basePath %>/app/packages/**/*',
          '!<%= basePath %>/app/public/components/**/*'
        ],
        tasks: watchTasks
      },
      bgShell: {
      ...
      'jshint': {
        app: {
          ...
          src: [
            '<%= basePath %>/app/**/*.js', '!<%= basePath %>/app/.meteor/**/*.js',
            '!<%= basePath %>/app/packages/**/*.js'
          ]
        },
        test: {
          options: rtdConf.options.jshint && rtdConf.options.jshint.testOptions ? rtdConf.options.jshint.testOptions : {},
          src: [
            '<%= basePath %>/test/**/*.js', '!<%= basePath %>/test/rtd/**/*.js', '!<%= basePath %>/test/rtd.conf.js',
            '!<%= basePath %>/test/karma.conf.js'
          ]
        }
      },
      'coffeelint': {
        app: {
          ...
          src: [
            '<%= basePath %>/app/**/*.coffee', '!<%= basePath %>/app/.meteor/**/*.coffee',
            '!<%= basePath %>/app/packages/**/*.coffee'
          ]
        },
        test: {
